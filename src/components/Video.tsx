        ...
        <div className="flex items-start gap-16">
          <div className="flex-1">
            <h1 className="text-2xl font-bold ">
              Aula 01 - Abertura do Ignite Labs
            </h1>
            ...
            <div className="flex items-center gap-4 mt-6">
				<img 
					...
					src="https://github.com/jaromaidukaitis.png" 
					alt="" />
				
				<div className="leading-relaxed">
					<strong className="font-bold text-2xl block">Jarom Aidukaitis</strong>
					<span className="text-gray-200 text-sm block">Mini Bio</span>
				</div>
			</div>
          </div>
